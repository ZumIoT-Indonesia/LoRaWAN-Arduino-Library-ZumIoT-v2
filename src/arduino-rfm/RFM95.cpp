...
#if defined(AS_923)
  static const PROGMEM unsigned char  LoRa_Frequency[8][3] = {//[921.2 - 922.6] MHz
    ...
    { 0xE6, 0xB3, 0x5A }, //Channel [5], 922.8 MHz / 61.035 Hz = x = 0xE6B35A 
    { 0xE6, 0xCC, 0xF4 }, //Channel [6], 923.2 MHz / 61.035 Hz = x = 0xE6CCF4
    { 0xE6, 0xD9, 0xC0 }, //Channel [7], 923.4 MHz / 61.035 Hz = x = 0xE6D9C0
